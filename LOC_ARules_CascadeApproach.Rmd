...
kable(DataFrame_pruned.rules_lhs1_conf33[c(1,3:5, 7:9,14:15)], "latex", booktabs = TRUE, longtable = TRUE, digits = 3, caption = "Determinants of LOC-Single Predictors") %>%
...
kable(DataFrame_pruned.rules_lhs2_conf50_nosubset[c(1:2,4:6, 8:10, 15:18)], "latex", booktabs = TRUE, longtable = TRUE, digits = 3, caption = "Determinants of LOC-Multiple Predictors") %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")) %>%
  landscape()
```
