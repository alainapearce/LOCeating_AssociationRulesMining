...
$\bullet$ all 11 had $\kappa$ $\ge$ 0.20 <p>
...
$\bullet$ all 48 had $\kappa$ $\ge$ 0.20 <p>
...
CEBQ 12 > Rarely (FR) + CFQ 26 = Dissagree (PE)
```{r LOCyes_CEBQ12.CFQ26, echo=FALSE, results='asis'}
kable(CEBQ12.CFQ26_tab, "latex", booktabs = TRUE, longtable = TRUE, digits = 3, caption = "Determinants of LOC: CEBQ 12 > Rarely (FR) + CFQ 26 = Dissagree (PE))") %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")) 
```
\FloatBarrier
...
CFQ 21 = Agree (Restrict) + CFQ 21 < Neutral (Restrict)
...
$\bullet$ 16  had $\kappa$ $\ge$ 0.20 <p>
$\bullet$ 678 had added value $\ge$ 0.05 <p>
$\bullet$ of the remaining 16 rules that met both criteria, all were significant after correction <p>

```{r LOCno_step2, echo=FALSE, results='asis'}
kable(DataFrame_pruned.rules_lhs2_conf50_no_nosubset[c(1:2,4:8,11:17)], "latex", booktabs = TRUE, longtable = TRUE, digits = 3, caption = "Determinants of No LOC-Multiple Predictors") %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```
...
Number of clusters:<p>
$\bullet$ 2: Connectivity<p>
$\bullet$ 3: lower sums of square, Silhouette width, Dunn Indexp>
$\bullet$ 4: APN, ADM (5 is AD and FOM) <p>
...
Average Silhouette Widths
```{r LOCno_step2_clust3_silplot, echo=FALSE, include=TRUE}
plot(silhouette(pruned.rules_lhs2_conf50_no_3clust), col = 2:3)
```
\FloatBarrier

Cluster Plot
```{r LOCno_step2_clust3_clusplot, echo=FALSE, include=TRUE}
#clusplot(pruned.rules_lhs2_conf50_no_3clust, main = "Cluster plot, k = 3", 
#         color = TRUE)
```
\FloatBarrier

Cluster 1
```{r LOCno_clust3.1_xtab, echo=FALSE,  results='asis'}
kable(xtabs_pruned.rules_lhs2_conf50_no_nosubset_clust3.1, "latex", booktabs = TRUE, longtable = TRUE, digits = 3, caption = "Determinants of NO LOC-Cluster 1") %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```
\FloatBarrier

```{r LOCno_clust3.1_qfreq, echo=FALSE,  results='asis'}
kable(qfreq_pruned.rules_lhs2_conf50_no_nosubset_clust3.1_LHS1, "latex", booktabs = TRUE, longtable = TRUE, digits = 3, caption = "Determinants of NO LOC-Cluster 1 Question Frequency") %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```
\FloatBarrier

Cluster 2
```{r LOCno_clust3.2_xtab, echo=FALSE,  results='asis'}
kable(xtabs_pruned.rules_lhs2_conf50_no_nosubset_clust3.2, "latex", booktabs = TRUE, longtable = TRUE, digits = 3, caption = "Determinants of NO LOC-Cluster 2") %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```
\FloatBarrier

```{r LOCno_clust3.2_qfreq, echo=FALSE,  results='asis'}
kable(qfreq_pruned.rules_lhs2_conf50_no_nosubset_clust3.2_LHS1, "latex", booktabs = TRUE, longtable = TRUE, digits = 3, caption = "Determinants of NO LOC-Cluster 2 Question Frequency") %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```

Cluster 3
```{r LOCno_clust3.3_xtab, echo=FALSE,  results='asis'}
kable(xtabs_pruned.rules_lhs2_conf50_no_nosubset_clust3.3, "latex", booktabs = TRUE, longtable = TRUE, digits = 3, caption = "Determinants of NO LOC-Cluster 3") %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```
\FloatBarrier

```{r LOCno_clust3.3_qfreq, echo=FALSE,  results='asis'}
kable(qfreq_pruned.rules_lhs2_conf50_no_nosubset_clust3.3_LHS1, "latex", booktabs = TRUE, longtable = TRUE, digits = 3, caption = "Determinants of NO LOC-Cluster 2 Question Frequency") %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```
...
$\bullet$ 14 rules contained a significant predictor from step 1 <p>
...
$\bullet$ 296  had $\phi$ $\ge$ 0.10 <p>
$\bullet$ 1855 had added value $\ge$ 0.05 <p>
$\bullet$ of the remaining 296 rules that met both criteria, 1 was significant after correction <p>
$\bullet$ of the remaining 296 rules that met both criteria, 255 were significant with no correction <p>  
\FloatBarrier
...
<!-- plot(silhouette(pruned.rules_lhs2_conf50_noHR_7clust)) -->
<!-- ``` -->
<!-- \FloatBarrier -->

<!-- Cluster Plot -->
<!-- ```{r HR_LOCno_step2_clust5_clusplot, echo=FALSE, include=TRUE} -->
<!-- clusplot(pruned.rules_lhs2_conf50_noHR_7clust, main = "Cluster plot, k = 7",  -->
<!--          color = TRUE) -->
<!-- ``` -->
<!-- \FloatBarrier -->
